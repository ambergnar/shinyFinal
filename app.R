...
CNGRSS <- read_excel("cngrssSHINY.xlsx")
...
cdf2 <- cdf %>%
  select(HouseDemocrats,HouseRepublicans,HouseOthers,SenateDemocrats,
         SenateRepublicans,SenateOthers,DemocratsTotal,RepublicansTotal,OthersTotal,
         HouseTotal,SenateTotal,CongressTotal,FemaleTotal,MaleTotal,
         FemaleDemocratsTotal,FemaleRepublicansTotal,FemaleOthersTotal,MaleDemocratsTotal,
         MaleRepublicansTotal,MaleOthersTotal,HouseDemocratsFemale,HouseRepublicansFemale,
         HouseOthersFemale,HouseDemocratsMale,HouseRepublicansMale,HouseOthersMale,
         SenateDemocratsFemale,SenateRepublicansFemale,SenateOthersFemale,
         SenateDemocratsMale,SenateRepublicansMale,SenateOthersMale,HouseTotalFemale,
         HouseTotalMale,SenateTotalFemale,SenateTotalMale,Year)
long_cdf <- gather(cdf2, Categories, Amounts, 1:36)
      ...
      tabPanel("1917-2020",
               sidebarPanel(
                 selectInput(inputId = "Category1",
                             ...
                             choices=c("HouseDemocrats","HouseRepublicans","HouseOthers","SenateDemocrats",
                                       "SenateRepublicans","SenateOthers","DemocratsTotal","RepublicansTotal",
                                       "OthersTotal","HouseTotal","SenateTotal","CongressTotal","FemaleTotal",
                                       "MaleTotal","FemaleDemocratsTotal","FemaleRepublicansTotal",
                                       "FemaleOthersTotal","MaleDemocratsTotal","MaleRepublicansTotal",
                                       "MaleOthersTotal","HouseDemocratsFemale","HouseRepublicansFemale",
                                       "HouseOthersFemale","HouseDemocratsMale","HouseRepublicansMale",
                                       "HouseOthersMale","SenateDemocratsFemale","SenateRepublicansFemale",
                                       "SenateOthersFemale","SenateDemocratsMale","SenateRepublicansMale",
                                       "SenateOthersMale","HouseTotalFemale",
                                       "HouseTotalMale","SenateTotalFemale","SenateTotalMale","Choose None"),
                             selected="FemaleTotal"),
               ...
               sidebarPanel(
                 selectInput(inputId = "Cat1",
                             ...
                             choices=c("HouseDemocrats","HouseRepublicans","HouseOthers","SenateDemocrats",
                                       ...
                                       "SenateOthersFemale","SenateDemocratsMale","SenateRepublicansMale",
                                       "SenateOthersMale","HouseTotalFemale",
                                       "HouseTotalMale","SenateTotalFemale","SenateTotalMale"),
                             selected="FemaleTotal")
               ),
               mainPanel(
                 tabsetPanel(
